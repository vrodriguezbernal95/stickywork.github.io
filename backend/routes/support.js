...
/**
 * PATCH /api/support/messages/:id/respond
 * Responder a un mensaje (super-admin)
 */
router.patch('/messages/:id/respond', requireSuperAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        ...
        // Obtener mensaje actualizado con info del negocio
...
/**
 * PATCH /api/support/messages/:id/close
 * Cerrar un mensaje (super-admin)
 */
router.patch('/messages/:id/close', requireSuperAdmin, async (req, res) => {
    try {
        const { id } = req.params;
